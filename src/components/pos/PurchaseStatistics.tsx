                  ...
                  <Table>
                    ...
                    <TableBody>
                      {topSuppliers.length === 0 ? (
                        <TableRow>
                          <TableCell colSpan={4} className="text-center py-8 text-muted-foreground text-xs">কোনো তথ্য নেই</TableCell>
                        </TableRow>
                      ) : (
                        topSuppliers.map((s, index) => (
                          <TableRow key={s.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/50">
